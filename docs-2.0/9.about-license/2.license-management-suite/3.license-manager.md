...
- 使用 Kubectl 部署集群时，在集群配置文件中，通过`spec.metad.licenseManagerURL`字段配置 LM 的地址和端口。详情参见[使用 Kubectl 部署](../../nebula-operator/3.deploy-nebula-graph-cluster/3.1create-cluster-with-kubectl.md)。
